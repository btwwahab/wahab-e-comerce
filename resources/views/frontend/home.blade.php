            ...
            <div class="product__item">
              <div class="product__banner">
                <a href="{{route('detail')}}" class="product__images">
                  ...
                  />
                  <img
                    src="{{asset('assets/img/product-1-2.jpg')}}" alt=""
            ...
            <div class="product__item">
              <div class="product__banner">
                <a href="{{route('detail')}}" class="product__images">
                  ...
                  />
                  <img
                    src="{{asset('assets/img/product-2-2.jpg')}}" alt=""
                    class="product__img hover"
                  />
                </a>
                <div class="product__actions">
            ...
            <div class="product__item">
              <div class="product__banner">
                <a href="{{route('detail')}}" class="product__images">
                  ...
                  />
                  <img
                    src="{{asset('assets/img/product-3-2.jpg')}}" alt=""
                    class="product__img hover"
                  />
                </a>
                <div class="product__actions">
            ...
            <div class="product__item">
              <div class="product__banner">
                <a href="{{route('detail')}}" class="product__images">
                  ...
                  />
                  <img
                    src="{{asset('assets/img/product-4-2.jpg')}}" alt=""
                    class="product__img hover"
                  />
                </a>
                <div class="product__actions">
            ...
            <div class="product__item">
              <div class="product__banner">
                <a href="{{route('detail')}}" class="product__images">
                  ...
                  />
                  <img
                    src="{{asset('assets/img/product-5-2.jpg')}}" alt=""
                    class="product__img hover"
                  />
                </a>
                <div class="product__actions">
            ...
            <div class="product__item">
              <div class="product__banner">
                <a href="{{route('detail')}}" class="product__images">
                  ...
                  />
                  <img
                    src="{{asset('assets/img/product-6-2.jpg')}}" alt=""
                    class="product__img hover"
                  />
                </a>
                <div class="product__actions">
            ...
            <div class="product__item">
              <div class="product__banner">
                <a href="{{route('detail')}}" class="product__images">
                  ...
                  />
                  <img
                    src="{{asset('assets/img/product-7-2.jpg')}}" alt=""
                    class="product__img hover"
                  />
                </a>
                <div class="product__actions">
            ...
            <div class="product__item">
              <div class="product__banner">
                <a href="{{route('detail')}}" class="product__images">
                  ...
                  />
                  <img
                    src="{{asset('assets/img/product-8-2.jpg')}}" alt=""
                    class="product__img hover"
                  />
                </a>
                <div class="product__actions">
            ...
            <div class="product__item">
              <div class="product__banner">
                <a href="{{route('detail')}}" class="product__images">
                  ...
                  />
                  <img
                    src="{{asset('assets/img/product-9-2.jpg')}}" alt=""
                    class="product__img hover"
                  />
                </a>
                <div class="product__actions">
            ...
            <div class="product__item">
              <div class="product__banner">
                ...
                alt=""
                  ...
                  />
                  <img
                    src="{{asset('assets/img/product-10-2.jpg  ') }} "
                 alt=""
                    class="product__img hover"
                  />
                </a>
            ...
            <div class="product__item">
              <div class="product__banner">
               ...
               alt=""
                  ...
                  />
                  <img
                    src="{{asset('assets/img/product-11-2.jpg') }} "
                 alt=""
                    class="product__img hover"
                  />
                </a>
            ...
            <div class="product__item">
              <div class="product__banner">
               ...
               alt=""
                  ...
                  />
                  <img
                    src="{{asset('assets/img/product-12-2.jpg  ') }}  "
                alt=""
                    class="product__img hover"
                  />
                </a>
            ...
            <div class="product__item">
              <div class="product__banner">
                <a href="{{route('detail')}}" class="product__images">
                  ...
                  />
                  <img
                    src="{{asset('assets/img/product-13-2.jpg')}}" alt=""
                    class="product__img hover"
                  />
                </a>
                <div class="product__actions">
            ...
            <div class="product__item">
              <div class="product__banner">
                <a href="{{route('detail')}}" class="product__images">
                  ...
                  />
                  <img
                    src="{{asset('assets/img/product-10-2.jpg')}}" alt=""
                    class="product__img hover"
                  />
                </a>
                <div class="product__actions">
          ...
          <div class="product__item swiper-slide">
            <div class="product__banner">
              <a href="{{route('detail')}}" class="product__images">
                ...
                />
                <img
                  src="{{asset('assets/img/product-6-2.jpg   ') }}"
               alt=""
                  class="product__img hover"
                />
              </a>
          ...
          <div class="product__item swiper-slide">
            <div class="product__banner">
              <a href="{{route('detail')}}" class="product__images">
                ...
                />
                <img
                  src="{{asset('assets/img/product-7-2.jpg')}} "
             alt=""
                  class="product__img hover"
                />
              </a>

                ...
                <div class="checkout__group">
                    ...
                    <table class="order__table">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <img src="{{ asset('assets/img/product-1-2.jpg') }}" alt="" class="order__img" />
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <img src="{{ asset('assets/img/product-2-1.jpg') }}" alt="" class="order__img" />
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <img src="{{ asset('assets/img/product-7-1.jpg') }}" alt="" class="order__img" />
                                </td>
                                <td>

        ...
        <section class="compare container section--lg">
            <table class="compare__table">
                <tr>
                    <th>Image</th>
                    <td>
                        <img src="{{ asset('assets/img/product-2-1.jpg') }}" alt="" class="compare__img" />
                    </td>
                    <td>
                        <img src="{{ asset('assets/img/product-4-1.jpg') }}" alt="" class="compare__img" />
                    </td>
                    <td>
                        <img src="{{ asset('assets/img/product-7-1.jpg') }}" alt="" class="compare__img" />
                    </td>
                </tr>
                <tr>
                    <th>Name</th>

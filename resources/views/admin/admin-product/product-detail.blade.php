                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h2 class="fw-medium my-3">$80.00 <span
                                    class="fs-16 text-decoration-line-through">$100.00</span><small
                            ...
                            <p class="text-muted">Top in sweatshirt fabric made from a cotton blend with a soft brushed
                                inside. Relaxed fit with dropped shoulders, long sleeves and ribbing around the neckline,
                                cuffs and hem. Small metal text applique. <a href="#!" class="link-primary">Read
                                    more</a></p>
